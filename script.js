...
document.addEventListener('click', (e) => {
    if (e.target.id === 'cartOverlay') document.getElementById('cartSidebar').classList.remove('open');
    if (e.target.id === 'checkoutModalBg') document.getElementById('checkoutModalBg').classList.remove('open');
});
